...
class GetDiffTagTest extends React.Component {
	constructor (props){
		super(props);
		this.state = {
			expected: "",
			description: "Get another agent with different tag method",
	...
	componentDidMount(){
		console.log("GetDiffTag mounted");
		this.makeApiCall();
	}

	makeApiCall(){
		console.log("making api call for GetDiffTag");
