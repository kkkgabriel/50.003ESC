...
class App extends React.Component {
  ...
  constructor(props) {
    ...
    // I do not fully understand what axiom is for
  ...
  addMessage = ({ message }) => {
      ...
      // initialized as bot, only after connection then it will change to a rainbow user
  ...
  newMessageBot(message){
    // remember that this is sent by dialogue flow
    // let allows you to declare vairable that is limited to a scope of a block
    let newMessage = Object.assign({}, message);
    ...
    if(messagecheck[messagecheck.length-1]==="name"){
